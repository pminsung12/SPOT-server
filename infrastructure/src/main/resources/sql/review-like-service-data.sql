...
CREATE TABLE IF NOT EXISTS members (
    ...
    sns_provider VARCHAR(20) NOT NULL,
...
INSERT INTO members (
    id, email, name, nickname, phone_number, level_id, profile_image,
    sns_provider, id_token, team_id, role, created_at, updated_at, deleted_at
) VALUES (
    1, 'test@example.com', '테스트유저', 'tester', '010-1234-5678', 1,
    NULL, 'KAKAO', 'dummy-id-token', 1, 'ROLE_USER', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL
);
